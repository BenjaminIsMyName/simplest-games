...
# Background
background = image.load('27/background.png') # 11

# Background sound
mixer.music.load("27/background.wav") # 80
mixer.music.play() # 81 (for loop, pass -1 to the play() function)

# Player
player_surf = image.load('27/player.png') # 13
...
for i in range(num_of_enemies): # 46
    enemy_imgs.append(image.load('27/enemy.png')) # 47
...
# Bullet
bullet_surf = image.load('27/bullet.png') # 27  
...
while running: # 5
        ...
        if e.type == KEYDOWN: # 30
            ...
            if e.key == K_SPACE: # 31
                ...
                if bullet_state == "ready": # 32
                    ...
                    bullet_sound = mixer.Sound("27/laser.wav") # 82
    ...
    for i in range(num_of_enemies): # 54
        ...
        if enemy_rects[i].colliderect(bullet_rect) and bullet_state == "fire": # 70
            ...
            explosion_sound = mixer.Sound("27/explosion.wav") # 84
